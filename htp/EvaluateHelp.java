...
public class EvaluateHelp {
	...
	public static boolean getSinglePrecisionApproach2 (ArrayList<String> predictedHashTags, ArrayList<String> actualHashTags){
	 ...
	 * @return
	 */
	public static int getSingleRecallApproach2 (ArrayList<String> predictedHashTags, ArrayList<String> actualHashTags){
		int count = 0; 
		for(String predicted : predictedHashTags){
			if(actualHashTags.contains(predicted)){
				count++;
